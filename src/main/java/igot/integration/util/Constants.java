...
public class Constants {
	...
	public static final String API_EHRMS_DASHBOARD = "api.igot.dashboard";
	...
	public static final String EHRMS_FIELDS = "ehrmsFields";
	public static final String NON_EHRMS_FIELDS = "nonEhrmsFields";
