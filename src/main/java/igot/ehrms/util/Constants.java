...
public class Constants {
	...
	public static final String[] DEFINED_ENDPOINTS={ENROLMENTS_PATH,CREATE_USER_PATH.substring(0, CREATE_USER_PATH.length()-2), AUTH_PATH, METRICS_PATH.substring(0, METRICS_PATH.length()-2)};
